...
description: Conecte la base de datos de Amazon RDS a Commerce Intelligence. Siga los pasos de configuración para sincronizar datos de motores de base de datos RDS compatibles con su Data Warehouse.
