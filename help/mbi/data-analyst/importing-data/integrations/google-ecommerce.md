...
description: Conecte los datos de comercio electrónico de Google a Commerce Intelligence para realizar un seguimiento de los canales de referencia más valiosos y analizar los ingresos junto con las demás fuentes de datos.
