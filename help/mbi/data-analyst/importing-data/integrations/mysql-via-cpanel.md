...
description: Conecte una base de datos MySQL alojada en cPanel a Commerce Intelligence. Cree un usuario dedicado e introduzca los detalles de conexión para empezar a sincronizar los datos.
...
>[!NOTE]
>
>Si utiliza un túnel SSH, consulte [Verificación de la clave del host SSH](ssh-host-key-verification.md) para obtener información sobre inscripción, actualización, mensajes de error y solución de problemas.
