...
| `product_type` | Tipo de producto que se vendió. Los [tipos de productos](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/product-create.html#product-types) potenciales incluyen: simple, configurable, agrupado, virtual, agrupado y descargable. |
...
| `Order item total value (quantity * price)` | Valor total de un artículo de pedido en el momento de la venta después de aplicar [reglas de precio de catálogo, descuentos por niveles y precios especiales](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/pricing/pricing-advanced.html), y antes de aplicar impuestos, envíos o descuentos en el carro de compras. Se calcula multiplicando `qty_ordered` por `base_price`. |
