...
En la tabla siguiente se describen los elementos incluidos con una cuenta heredada de `Essentials` en comparación con una cuenta actual de Commerce Intelligence. Adobe ya no ofrece `Essentials`.
