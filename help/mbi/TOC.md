...
- Analizar datos {#analyze}
   ...
   - Integraciones de bases de datos {#integration}
      ...
      - [Verificación de la clave del host SSH](data-analyst/importing-data/integrations/ssh-host-key-verification.md)
...
- Tutoriales {#tutorials}
   ...
   - [Creando visualizaciones a partir de una  [!DNL SQL] consulta](tutorials/create-visuals-from-sql.md)
